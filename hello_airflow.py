...
def hello_airflow():
    ...
    # For now, it will just print "Hello, airflow!" to the console
    print("Hello, airflow!")
...
dag = DAG(
    "hello_airflow",  # This is the ID of the DAG
    default_args={
        "start_date": datetime(
            2025, 1, 1
...
hello_airflow_task = PythonOperator(
    task_id="hello_airflow",  # This is the ID of the task
    python_callable=hello_airflow,  # This is the function to call
